...
<script>
    layui.use(['layer', 'form', 'table', 'util', 'admin'], function () {
        ...
        var insTb = table.render({
            elem: '#tableUser',
            url: '${ctx}/rollCall/list.json',
            page: true,
            toolbar: true,
            cellMinWidth: 100,
            cols: [[
                {type: 'numbers'},
                {field: 'classInfo',  title: '班级', templet: function (d) {
                        return d.rollCall.classInfo.name;
                    }
                },
                ...
                {field: 'course',  title: '课程'
                    , templet: function (d) {
                        return d.rollCall.course.name;
                    }
                },
                {field: 'week',  title: '周次', templet: function (d) {
                        return d.rollCall.week;
                    }
                },
                {
