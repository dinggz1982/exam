	...
	<script>
		layui.use([ 'layer', 'form', 'table', 'util', 'admin', 'zTree','upload', 'layedit'], function() {
			...
			form.on('submit(submit)', function (data) {
				layer.load(2);
				$.post('${ctx}/teacher/homework/addHomework', data.field, function (res) {
			...
			var fileListView = upload.render({
				elem: '#files'
				,url: '${ctx}/teacher/homework/upload' //上传接口
				,accept: 'file' //允许不同的格式
			...
			var insTb = table.render({
				...
				url : '${ctx}/teacher/homework/list.json',
				page : true,
				toolbar : true,
				cellMinWidth : 100,
				cols : [ [
