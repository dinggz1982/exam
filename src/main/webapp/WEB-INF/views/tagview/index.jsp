...
<html>
  <head>
    ...
    <link href="${ctx}/assets/libs/tag/bootstrap.min.css" rel="stylesheet">
	<script type="text/javascript" src="${ctx}/assets/libs/tag/jquery.min.js"></script>
	<script type="text/javascript" src="${ctx}/assets/libs/tag/bootstrap.min.js"></script>
	<style type="text/css">
		canvas{
			/* background: blue; */
...
<!--   		<input type="button" id="preserve" value="Preserve"/>&nbsp; -->
	...
	<script type="text/javascript" src="${ctx}/assets/libs/tag/mywc.js"></script>
