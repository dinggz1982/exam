    ...
    <form id="modelCollegeForm" lay-filter="modelCollegeForm" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="name" placeholder="请输入专业名称" type="text" class="layui-input" maxlength="20"
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
               	<select name="college_id" id="college_">
				</select>
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label layui-form-required">专业简介</label>
            <div class="layui-input-block">
...
<script>
    layui.use(['layer', 'form', 'table', 'util', 'admin'], function () {
        ...
        var insTb = table.render({
            ...
            url: '${ctx}/profile/major/list.json',
            page: true,
            toolbar: true,
            cellMinWidth: 100,
            cols: [[
                ...
                {field: 'schoolName', sort: true, title: '学校-学院',templet: function (d) {
                        return d.college.school.name + "-" +  d.college.name;
                    }},
                {
        ...
        function showEditModel(mCollege) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = '${ctx}/profile/major/edit';
                    // 回显数据
        ...
        // 删除
        function doDel(majorId, majorName) {
            layer.confirm('确定要删除“' + majorName + '”吗？', {
                skin: 'layui-layer-admin',
                shade: .1
            }, function (i) {
                layer.close(i);
                layer.load(2);
                $.post('${ctx}/profile/major/delete', {
                    majorId: majorId
                }, function (res) {
                    layer.closeAll('loading');
                    if (res.code == 200) {
