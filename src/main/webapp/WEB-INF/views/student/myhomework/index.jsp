...
<body>
				...
				<div class="layui-form toolbar">
					<div class="layui-form-item">
						<div class="layui-inline">
							<label class="layui-form-label w-auto">选择课程：</label>
						...
						<div class="layui-inline">
							<label class="layui-form-label w-auto">作业名称：</label>
							<div class="layui-input-inline mr0">
						...
						<div class="layui-inline" style="padding-right: 110px;">
							<button class="layui-btn icon-btn"
								lay-filter="formSubSearchHomework" lay-submit>
    ...
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="mhomewoek">查看我的作业</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="upload">提交作业</a>
</script>
	<!-- 表单弹窗 -->
	...
	<script>
		layui.use([ 'layer', 'form', 'table', 'util', 'admin', 'zTree','upload', 'layedit'], function() {
			...
			var insTb = table.render({
				...
				url : '${ctx}/student/homework/list.json',
				page : true,
				toolbar : true,
				cellMinWidth : 100,
				cols : [ [
			...
			table.on('tool(tableHomework)', function(obj) {
				...
				if (layEvent === 'mhomework') { // 查看我的作业
					showEditModel(data);
				} else if (layEvent === 'upload') { // 提交作业
	        ...
	        function showEditModel(mHomework) {
	            admin.open({
	                ...
	                success: function (layero, dIndex) {
	                    ...
	                    var url = '${ctx}/homework/myhomework';
	                    // 回显数据
